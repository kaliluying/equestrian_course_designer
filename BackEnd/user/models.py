...
class DesignComment(models.Model):
    ...
    design = models.ForeignKey(Design, on_delete=models.CASCADE, related_name='comments', verbose_name='设计')
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='design_comments', verbose_name='用户')
    content = models.TextField(verbose_name='评论内容')
    obstacle_id = models.CharField(max_length=100, blank=True, null=True, verbose_name='关联障碍物ID')
    x = models.FloatField(null=True, blank=True, verbose_name='画布X坐标')
    y = models.FloatField(null=True, blank=True, verbose_name='画布Y坐标')
...
class CollaborationRole(models.Model):
    ...
    design = models.ForeignKey(Design, on_delete=models.CASCADE, related_name='collaboration_roles', verbose_name='设计')
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='collaboration_roles', verbose_name='用户')
...
class CollaborationEvent(models.Model):
    ...
    design = models.ForeignKey(Design, on_delete=models.CASCADE, related_name='collaboration_events', verbose_name='设计')
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='collaboration_events', verbose_name='用户')
