...
import { useCanvasCollaboration } from '@/composables/useCanvasCollaboration'
...
// 协作相关逻辑已移至 composables/useCanvasCollaboration.ts
...
// sendFullCanvasState 和 isCreator 已移至 composables/useCanvasCollaboration.ts
